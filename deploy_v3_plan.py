"""UPGRADE_PLAN_v3.md + MANUAL.md GitHub 배포"""
...
def gh_api(path, method="GET", data=None):
    ...
    h = {"Authorization": f"token {TOKEN}", "Accept": "application/vnd.github.v3+json",
         "Content-Type": "application/json", "User-Agent": "deploy_v3_plan.py"}
...
files = {
    "UPGRADE_PLAN_v3.md": "docs: v3.0 기획서 — PC저장폴더3개, 에이전트3중검증, F-01모순수정, 최종확정",
    "MANUAL.md": "docs: 매뉴얼 — STT 엔진별 성능·제한·주의사항 섹션 추가",
}
