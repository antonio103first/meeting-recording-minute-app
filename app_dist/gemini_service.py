...
9. 미팅 요약 원칙: "## 미팅 요약" 섹션은 전체 문서를 집필하기 전에 녹취 전체를 먼저 파악하여 작성.
   미팅 목적·핵심 논의·초기 판단 3항목 필수 기재. 경영진 보고 수준의 압축 서술 (각 항목 2~4줄)
...
**미팅 목적**
(이번 IR 미팅의 주요 목적·배경을 1~2줄로 기술. 문체는 "~임", "~함" 종결)

**핵심 논의 내용**
(녹취에서 다뤄진 주요 아젠다를 항목별로 요약. 수치·결정사항 포함. 문체는 "~임", "~함" 종결)

**주요 결론 및 초기 판단**
(미팅을 통해 도출된 핵심 판단, 투자 관점 초기 결론, 후속 확인 필요 사항. 문체는 "~임", "~함" 종결)
